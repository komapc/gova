...
const I18n = (() => {
  ...
  const STRINGS = {
    en: {
      ...
      satLabel: 'SAT',
      baroLabel: 'BARO',
      aboveSeaCap: 'height above sea',
      belowSeaCap: 'below sea level',
      youLabel: 'You',
      youSub: 'where you are',
      groundLabel: 'Ground',
      groundSub: 'surface below you',
      seaLabel: 'Sea',
      seaSub: 'zero level',
      aboveGroundLabel: 'ABOVE GROUND',
      onGroundSub: 'on the ground',
    ...
    eo: {
      ...
      satLabel: 'SAT',
      baroLabel: 'BARO',
      aboveSeaCap: 'alteco super maro',
      belowSeaCap: 'sub marnivelo',
      youLabel: 'Vi',
      youSub: 'kie vi estas',
      groundLabel: 'Tero',
      groundSub: 'surfaco sub vi',
      seaLabel: 'Maro',
      seaSub: 'nula nivelo',
      aboveGroundLabel: 'SUPER TERO',
      onGroundSub: 'sur la tero',
      terrainLoading: 'tero ŝarĝiĝas…',
      privacy: 'Privateco',
    ...
    lv: {
      ...
      satLabel: 'SAT',
      baroLabel: 'BARO',
      aboveSeaCap: 'augstums virs jūras',
      belowSeaCap: 'zem jūras līmeņa',
      youLabel: 'Tu',
      youSub: 'kur tu atrodies',
      groundLabel: 'Zeme',
      groundSub: 'virsma zem tevis',
      seaLabel: 'Jūra',
      seaSub: 'nulles līmenis',
      aboveGroundLabel: 'VIRS ZEMES',
      onGroundSub: 'uz zemes',
      terrainLoading: 'ielādē reljefu…',
      privacy: 'Privātums',
    ...
    be: {
      ...
      satLabel: 'САТ',
      baroLabel: 'БАРО',
      aboveSeaCap: 'вышыня над морам',
      belowSeaCap: 'ніжэй за ўзровень мора',
      youLabel: 'Ты',
      youSub: 'дзе ты знаходзішся',
      groundLabel: 'Зямля',
      groundSub: 'паверхня пад табой',
      seaLabel: 'Мора',
      seaSub: 'нулявы ўзровень',
      aboveGroundLabel: 'НАД ЗЯМЛЁЙ',
      onGroundSub: 'на зямлі',
      terrainLoading: 'рэльеф загружаецца…',
      privacy: 'Прыватнасць',
    ...
    tp: {
      ...
      satLabel: 'MUN',
      baroLabel: 'KON',
      aboveSeaCap: 'sewi pi telo suli',
      belowSeaCap: 'anpa pi telo suli',
      youLabel: 'sina',
      youSub: 'sina lon ni',
      groundLabel: 'ma',
      groundSub: 'ma lon anpa sina',
      seaLabel: 'telo suli',
      seaSub: 'nanpa ala',
      aboveGroundLabel: 'SEWI MA',
      onGroundSub: 'lon ma',
      terrainLoading: 'ma li kama…',
      privacy: 'sona awen',
