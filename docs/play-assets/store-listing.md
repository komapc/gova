...
```
Precise GPS & barometric altimeter — your altitude in real time.
```

**Full description**
```
Gova is an ultra-simple, precise altimeter. Open it and instantly see how high you are — no clutter, no account, no ads.

Gova combines several sources to show your altitude accurately:
...
```
Preciza altimetro per GPS kaj barometro — via alteco en reala tempo.
```

**Full description**
```
Gova estas ultra-simpla, preciza altimetro. Malfermu ĝin kaj tuj vidu kiom alte vi estas — sen malordo, sen konto, sen reklamoj.

Gova kombinas plurajn fontojn por montri vian altecon precize:
